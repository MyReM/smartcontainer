<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input clearable @keyup.enter.native="search" style="width: 200px;" size="small" class="filter-item" placeholder="权限编码" v-model="listQuery.permissionCode"></el-input>
      <el-input clearable @keyup.enter.native="search" style="width: 200px;" size="small" class="filter-item" placeholder="权限名称" v-model="listQuery.permissionName"></el-input>
    ...
    <el-table :data="list" size="mini" v-loading.body="listLoading" element-loading-text="Loading" stripe border fit highlight-current-row>
      ...
      <!-- <el-table-column align="center" label='ID' prop="permissionId" width="95"></el-table-column> -->
      <el-table-column type="index" width="55" align="center"></el-table-column>

      <el-table-column label="权限编码" width="110" prop="permissionCode" align="center"></el-table-column>

      <el-table-column label="权限名称" width="110" prop="permissionName" align="center"></el-table-column>
    ...
    <div style="margin-top: 10px;">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
        ...
        <el-form-item label="权限编码" prop="permissionCode">
					<el-input v-model="temp.permissionCode"></el-input>
				</el-form-item>

				<el-form-item label="权限名称" prop="permissionName">
					<el-input v-model="temp.permissionName"></el-input>
				</el-form-item>
...
import { permission, findAllPage, insert, update, deleted } from '@/api/permission'
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        permissionCode: [{ required: true, message: 'timestamp is required', trigger: 'blur' }],
        permissionName: [{ required: true, message: '角色名不能为空！', trigger: 'blur' }]
      },
      temp: permission
    }
  },
  ...
  methods: {
    ...
    search() {
      if (this.listQuery.permissionName == null && this.listQuery.permissionCode == null) {
        return
      }
      if (this.listQuery.permissionCode === '') {
        this.listQuery.permissionName = null
      }
      this.fetchData()
    },
    handleCreate() {
    ...
    handleDelete(row) {
      this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
        ...
        deleted(row.permissionId).then((response) => {
          this.$message({
            type: 'success',
            message: '删除成功!'
          })
