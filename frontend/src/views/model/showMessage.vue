<template>
  <div id="first"> 
    <el-collapse-transition>
      <div id="first-div" v-show="showmessageModel">
    ...
    <el-collapse-transition>
      <div id="second-div" v-show="showmessagesModel">
...
<style>
  ...
  #first-div .oneGoodsWidth {
    width:36% !important;
    margin:0 0 0 34% !important;
  }
  #first-div .twoGoodsWidth {
   width:40% !important;
   margin: 0 0 0 110px !important;
  }
  #first-div .threeGoodsWidth {
    width:33.3% !important;
  }
  #first-div .fourGoodsWidth {
    width: 25% !important;
  }
  #first-div{
    width: 100%;
